...
class Project(models.Model):
    ...
    project_contact = models.ForeignKey(CustomUser, related_name=u"main_business", verbose_name=u"主要负责人",on_delete = models.CASCADE)
    project_contact_backup = models.ForeignKey(CustomUser, related_name=u"backup_business", verbose_name=u"第二负责人", on_delete = models.CASCADE)
    description = models.TextField(blank=True, null=True, verbose_name=u'业务说明')
    line = models.ForeignKey(Line, null=True, blank=True, related_name=u"business", verbose_name=u"产品线", db_index=False, on_delete=models.CASCADE)
...
class PublishingSystem(models.Model):
    uuid = models.CharField(max_length=64, auto_created = True, unique=True, default = uuid.uuid1())
    project_name = models.IntegerField(verbose_name=u"项目名称")
...
class ProjectUser(models.Model):
    uuid = models.CharField(max_length=64, auto_created = True, unique=True, default = uuid.uuid1())
    project = models.ForeignKey(Project, db_index=False, on_delete = models.CASCADE)
    user = models.ForeignKey(CustomUser, blank=True, null=True, on_delete=models.CASCADE, related_name=u"all_business")
...
class Host(models.Model):
    ...
    idc = models.ForeignKey(IDC, blank=True, null=True, verbose_name=u'机房', on_delete=models.CASCADE)
    ...
    internal_ip = models.GenericIPAddressField(blank=True, null=True, verbose_name=u'远控卡')
    ...
    business = models.ManyToManyField(Project, blank=True,  verbose_name=u'所属业务')
    u"""
    0   未安装系统
    1   已安装系统
    2   正在安装中
    ...
    vm = models.ForeignKey("self", blank=True, null=True, verbose_name=u"虚拟机父主机", on_delete = models.CASCADE)
    ...
    service = models.ManyToManyField(Service, verbose_name=u'运行服务', blank=True)
...
class project_swan(models.Model):
    ...
    node = models.ManyToManyField(Host, blank=True, verbose_name=u'主机')
    push_user = models.ManyToManyField(CustomUser, blank=True, verbose_name=u"发布权限")
    ...
    git_code = models.ForeignKey(gitCode, verbose_name=u'发布仓库', default="", blank=True, null=True,
                                 help_text=u"如未填写,则默认以服务器目录git仓库为准,接取代码会直接pull不会有其它操作", on_delete = models.CASCADE)
...
class IpList(models.Model):
    uuid = models.CharField(max_length=64, auto_created = True, unique=True, default = uuid.uuid1())
    idc = models.ForeignKey(IDC, verbose_name=u"IDC", on_delete = models.CASCADE)
